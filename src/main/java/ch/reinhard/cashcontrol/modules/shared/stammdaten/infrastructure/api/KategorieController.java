package ch.reinhard.cashcontrol.modules.shared.stammdaten.infrastructure.api;
...
public class KategorieController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Alle Kategorien gefunden",
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Kategorie erfasst",
