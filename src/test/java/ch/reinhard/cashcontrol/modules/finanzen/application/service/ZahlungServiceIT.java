...
import ch.reinhard.cashcontrol.modules.finanzen.api.ZahlungUpdateDto;
...
public class ZahlungServiceIT {
    ...
    public void createZahlung() {
        ...
        var zahlungDto = new ZahlungDetailsDto(
                LocalDate.now(), "Beat Reinhard, Frutigen", "K1", "Lohn", new BigDecimal("1500.60"));
    ...
    public void updateZahlung() {
        ...
        var zahlungDetails = new ZahlungDetailsDto(
                createdZahlung.datum(), "Neu", "Lohn", createdZahlung.kategorieId(), createdZahlung.betrag());

        var zahlungUpdateDto = new ZahlungUpdateDto(createdZahlung.id(), createdZahlung.version(), zahlungDetails);
    ...
    public void getAllZahlung() {
        // GIVEN
        var zahlungDto1 =
                new ZahlungDetailsDto(LocalDate.now(), "Hans Kummer, Bern", "K2", "Lohn", new BigDecimal("1599.95"));
        var zahlungDto2 = new ZahlungDetailsDto(
                LocalDate.now(), "Beat Reinhard, Frutigen", "K1", "Lohn", new BigDecimal("83.10"));
    ...
    public void getZahlungById() {
        ...
        var zahlungDto = new ZahlungDetailsDto(LocalDate.now(), empfaenger, "K2", "Lohn", new BigDecimal("1599.95"));
